					...
					<form class="form-horizontal" role="form" method="POST" action="{{ url('/auth/register') }}">
						...
						<div class="form-group">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<input type="text" class="form-control icon" name="name" value="{{ old('name') }}" placeholder="Alisina">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="Alisina@example.com">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<input type="password" class="form-control icon" name="password_confirmation" placeholder="******">
							</div>
						</div>
