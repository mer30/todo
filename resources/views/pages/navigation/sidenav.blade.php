<nav>
    <div id="sidenav" class="sidebar sidebar-hidden z-index1050 text-capitalize hidden-xs text-left">
      <ul class="nav montserrat text-uppercase">
        <li class="text-center"><a href="#"><h4 class="lato fw500 text-white text-lowercase"></i>urs&nbsp;<sup><em class=""><span class="text-cyan">beta</span></em></sup></span> <span class="sr-only">(current)</span></h4></a></li>
        @if(Auth::check())
        <li class="">
            <a href="#">
